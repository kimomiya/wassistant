...
class _$SearchHistoryTearOff {
  ...
  _SearchHistory call(
      {@required UniqueId id, @required SearchWord searchWord}) {
...
abstract class $SearchHistoryCopyWith<$Res> {
  ...
  $Res call({UniqueId id, SearchWord searchWord});
}
...
class _$SearchHistoryCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      searchWord:
          searchWord == freezed ? _value.searchWord : searchWord as SearchWord,
    ));
  }
}
...
abstract class _SearchHistory implements SearchHistory {
  const factory _SearchHistory(
      ...
      @required SearchWord searchWord}) = _$_SearchHistory;
