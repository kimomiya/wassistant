...
import 'package:wassistant/core/error/failures.dart';
import 'package:wassistant/core/network/network_info.dart';
import 'package:wassistant/data/data_sources/player_remote_data_source.dart';
import 'package:wassistant/data/models/player_info_model.dart';
import 'package:wassistant/data/models/player_model.dart';
import 'package:wassistant/data/repositories/palyer_repository_impl.dart';
import 'package:wassistant/domain/entities/player.dart';
import 'package:wassistant/domain/entities/player_info.dart';
    ...
    () {
      ...
      group(
        ...
        () {
          ...
          test(
            'should return a list of Player when the call to remote data source is successful',
            () async {
              when(
      ...
      group(
        ...
        () {
          ...
          test(
            'should return ServerFailure without the call to remote data source',
            () async {
              final result = await repository.fetchPlayerList(tSearch);
    ...
    () {
      ...
      group(
        ...
        () {
          ...
          test(
            'should return PlayerInfo when the call to remote data source is successful',
            () async {
              when(
